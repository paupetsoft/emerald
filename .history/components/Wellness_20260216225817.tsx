...
export default function Wellness() {
  ...
  /* SPEED FIX: Increase the container to 500vh (slower scroll).
     DEADSPACE FIX: Map the movement to [0, 0.7]. 
     This means the horizontal slide is 100% DONE when you are only 
     70% through the scroll. The remaining 30% of the height is 
     swallowed by the footer rising up.
  */
  const x = useTransform(scrollYProgress, [0, 0.7], ["0%", "-400%"]);

  return (
    <section ref={targetRef} className="relative h-[500vh] bg-[#050a08]">
