...
export default function Wellness() {
  ...
  /* THE FIX: 
     Instead of [0, 1], we use [0, 0.9].
     This means the images finish moving when you are only 90% 
     through the section, leaving the last 10% to handle the 
     transition out to the footer with NO blank space.
  */
  const x = useTransform(scrollYProgress, [0, 0.9], ["0%", "-400%"]);
      ...
      <div className="sticky top-0 h-screen w-full flex items-center overflow-hidden">
        ...
        >
          ...
          <div className="w-screen h-screen flex-shrink-0 flex flex-col items-center justify-center">
            <span className="text-[#c5a059] text-[10px] tracking-[0.5em] uppercase mb-4 block">Wellness</span>
