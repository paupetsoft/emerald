          ...
          <div className="grid md:grid-cols-2 gap-20 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
              ...
              <div className="space-y-6 text-white/70 text-lg leading-relaxed font-light italic mb-8">
                <p>Emerald Suites offers well-furnished 1 BHK and 2 BHK serviced apartments providing the perfect balance of comfort and affordability.</p>
                <p>Designed with intercom and kitchen facilities to make you feel right at home.</p>
              </div>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <p className="text-white/60 leading-relaxed font-light italic text-lg">
              Kothanur Main Rd, next to Sansar Centre. Near Empire Restaurant.
            </p>
          </div>
        </div>
      </section>
