  ...
  return (
    <main className="bg-[#050a08] min-h-screen text-white relative">
      ...
      <section className="py-24 border-t border-white/10 px-6">
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-16 text-sm font-light italic text-white/60">
          <div>
            <h3 className="text-[#c5a059] text-[10px] tracking-[0.5em] uppercase mb-8 font-bold not-italic">Accommodations</h3>
            <p>1 & 2 BHK Fully Furnished Apartments with dedicated living and dining areas.</p>
          </div>
          <div>
            <h3 className="text-[#c5a059] text-[10px] tracking-[0.5em] uppercase mb-8 font-bold not-italic">Essentials</h3>
            <p>High-speed Wi-Fi, 24/7 Power Backup, and Daily Housekeeping included.</p>
          </div>
          <div>
            <h3 className="text-[#c5a059] text-[10px] tracking-[0.5em] uppercase mb-8 font-bold not-italic">Proximity</h3>
            <p>Hennur-Bagalur Airport Road, Next to Sansar Centre. Landmark: Empire Restaurant.</p>
          </div>
        </div>
      </section>
    </main>
