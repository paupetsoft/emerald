    ...
    <main className="bg-[#050a08] min-h-screen text-white">
      ...
      <section className="pt-40 pb-20 px-6">
        <div className="max-w-7xl mx-auto">
          <Link href="/" className="text-[#c5a059] text-[10px] tracking-[0.5em] uppercase mb-12 inline-block hover:opacity-50 transition-all font-bold">
            ← Back to Collection
          </Link>
          ...
          <div className="grid md:grid-cols-2 gap-20 items-start">
            ...
            >
              ...
              <p className="text-white/70 text-lg leading-relaxed font-light italic mb-8">
                Since 2018. Fully furnished 1 & 2 BHK units designed for the modern traveler. 
                Located next to Sansar Centre, offering the perfect balance of accessibility and serenity.
              </p>
            </motion.div>
            ...
            >
              <img src="/prop-suites.jpg" className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-1000" alt="Emerald Rooms" />
            </motion.div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-16">
          ...
          <div>
            ...
            <p className="text-white/60 leading-relaxed font-light italic">
              Conveniently situated on Hennur-Bagalur Airport Road. Landmark: Near Empire Restaurant. 
              Ideally placed for those needing quick access to the International Airport and tech parks.
            </p>
          </div>
        </div>
      </section>
